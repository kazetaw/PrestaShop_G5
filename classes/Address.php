...
class AddressCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields' => [
            ...
            'vat_number' => ['type' => self::TYPE_STRING, 'validate' => 'isVatNumber'],
            'address1' => ['type' => self::TYPE_STRING, 'validate' => 'isAddress', 'required' => true, 'size' => 128],
            'address2' => ['type' => self::TYPE_STRING, 'validate' => 'isAddress', 'size' => 128,'length' => 13],
            ...
            'phone' => ['type' => self::TYPE_STRING, 'validate' => 'isPhoneNumberth', 'size' => 32],
