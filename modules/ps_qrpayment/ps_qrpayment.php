...
class Ps_Qrpayment extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->trans('QR CODE', [], 'Modules.Wirepayment.Admin');
        $this->description = $this->trans('This is new module for generate qr', [], 'Modules.Wirepayment.Admin');
    ...
    public function hookPaymentOptions($params)
    {
        ...
        $newOption->setModuleName($this->name)
                ->setCallToActionText($this->trans('QR CODE', [], 'Modules.Wirepayment.Shop'))
                ->setAction($this->context->link->getModuleLink($this->name, 'validation', [], true))
                ->setAdditionalInformation($this->fetch('module:ps_qrpayment/views/templates/hook/ps_qrpayment_intro.tpl'));
        $payment_options = [
            $newOption,
        ];
    ...
    public function hookDisplayPaymentReturn($params)
    {
        ...
        return $this->fetch('module:ps_qrpayment/views/templates/hook/payment_return.tpl');
    }
