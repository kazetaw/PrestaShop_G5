 ...
 * @since 1.5.0
 *
 * @property Ps_Qrpayment $module
 */
class Ps_QRpaymentPaymentModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function initContent()
    {
        ...
        $this->context->smarty->assign([
            ...
            'confirm_url' => $this->context->link->getModuleLink('ps_qrpayment', 'validation', [], true),
            'image_url' => $this->module->getPathUri() . 'ps_qrpayment.jpg',
