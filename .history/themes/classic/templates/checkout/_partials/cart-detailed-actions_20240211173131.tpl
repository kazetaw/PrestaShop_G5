{**
 ...
 {block name='cart_detailed_actions'}
    ...
    <div class="modal-dialog" role="document">
     ...
     <!-- เพิ่มปุ่มหรือลิงค์ที่ต้องการให้ผู้ใช้ทำการจ่ายเงิน -->
          <div class="modal-body">
            ...
            <form id="slipUploadForm" action="/upload_script.php" method="post" enctype="multipart/form-data">
              ...
              <button type="submit" class="btn btn-primary" onclick="uploadSlip()">{l s='อัพโหลด' d='Shop.Theme.Actions'}</button>
            </form>
          </div>
        </div>
      </div>
  ...
  function uploadSlip() {
    ...
    document.getElementById('slipUploadForm').submit();
  }
</script>
  <script>
