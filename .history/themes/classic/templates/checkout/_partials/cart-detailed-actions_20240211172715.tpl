 ...
 {block name='cart_detailed_actions'}
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function handleUploadSuccess() {
      ...
      // Show a success message or perform any additional actions you need
      alert('Payment successful! Thank you for uploading the payment receipt.');
    ...
    uploadForm.addEventListener('submit', function (event) {
      ...
      // Simulate calling handleUploadSuccess() after successful upload
      setTimeout(handleUploadSuccess, 2000); // Simulating a delay of 2 seconds for demonstration purposes
    });

    // Additional code to handle modal events if needed
    attachmentModal._element.addEventListener('hidden.bs.modal', function () {
      // Add any additional code to execute after the modal is closed
    });
  });
</script>
 {/block}