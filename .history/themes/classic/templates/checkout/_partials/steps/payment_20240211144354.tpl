...
{block name='step_content'}
 ...
 <!-- เพิ่มส่วนนี้เพื่อแสดงข้อความหลังจากอัพโหลดไฟล์สลิปเสร็จสิ้น -->
{if isset($slip_uploaded_successfully)}
  <p class="cart-payment-step-success-message">{l s='Your slip file has been uploaded successfully.' d='Shop.Theme.Checkout'}</p>
{/if}
