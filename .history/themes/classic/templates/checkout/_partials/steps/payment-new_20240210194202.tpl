...
<div class="container">
    ...
    <div class="checkout-steps">
        <div class="checkout-content checkout-payment-step">
                ...
                <div>
                    <div id="{$option.id}-container" class="payment-option clearfix">
                        ...
                        <span class="custom-radio float-xs-left">
                            <input class="ps-shown-by-js {if $option.binary} binary {/if}" id="{$option.id}" data-module-name="{$option.module_name}" name="payment-option" type="radio" required {if ($selected_payment_option == $option.id || $is_free) || ($payment_options|@count === 1 && $module_options|@count === 1)} checked {/if}>
                            <span></span>
                        </span>
