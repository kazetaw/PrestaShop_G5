...
{block name='step_content'}
            ...
            if (fileType === 'jpg' || fileType === 'png') {
                ...
                reader.onload = function(e) {
                    ...
                    image.onload = function() {
                        ...
                        if (hasText) {
                            // ถ้าพบตัวอักษรในรูป
                            // ไม่ต้องทำอะไรเพิ่มเติมเพราะเราต้องการให้อัพโหลดไฟล์ที่มีตัวอักษร
                        } else {
                             // ถ้าพบตัวอักษรในรูป
                            alert("ไฟล์ที่เลือกมีตัวอักษร กรุณาเลือกรูปที่ไม่มีตัวอักษร");
                            // เคลียร์ input file
  ...
  <script>
var hasText = false;
var pixels = ...; // ข้อมูลพิกเซลของรูปภาพ
