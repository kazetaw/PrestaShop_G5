...
{block name='step_content'}
  ...
  <!-- ส่วนของการอัพโหลด Slip -->
  <div id="slip-upload" class="mt-3">
    <h2>Slip Upload</h2>
    <form id="slip-upload-form" enctype="multipart/form-data" method="POST" action="process_slip.php">
      <div class="form-group">
        <label for="slip-file">Choose file</label>
        <input type="file" class="form-control-file" id="slip-file" name="slip-file">
      </div>
